...
class IBertModel(IBertPreTrainedModel):
    ...
    def forward(
        ...
        return_dict = return_dict if return_dict is not None else None #self.config.use_return_dict
...
class IBertForSequenceClassification(IBertPreTrainedModel):
    ...
    def forward(
        ...
        """
        return_dict = return_dict if return_dict is not None else None #else self.config.use_return_dict
